...
| **Security Tools**         | Nuclei • Httpx • Subfinder • Amass • Trivy • ScoutSuite      |
| **Cloud & Infra**          | AWS • Docker • Terraform • Lambda                            |
| **Automation & Reporting** | jq • GitHub Actions • Slack API • Confluence • JIRA REST API |
| **Red Team & Pentest**     | Burp Suite • Metasploit • OWASP ZAP • Recon-ng • Feroxbuster |
...
🛡️ *"Automate security, not excuses."*
